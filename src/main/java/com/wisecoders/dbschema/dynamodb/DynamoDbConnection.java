    ...
    public DynamoDbConnection(String url, Properties props ) {
        ...
        if ( ( idx = url.indexOf( "?")) > -1 ){
            ...
            for ( String pair : params.split("&")) {
                ...
                props.put(keyVal[0], URLDecoder.decode(keyVal[1], StandardCharsets.UTF_8));
            }
        }

        this.dynamoDB =  AmazonDynamoDBClientBuilder.standard()
                .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration(url, props.getProperty(REGION, DEFAULT_REGION))).
                        build();
    }
